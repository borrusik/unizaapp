...
export const uk: TranslationDictionary = {
  ...
  schedule_break: "Перерва",
  schedule_hour_short: "год",
  schedule_minute_short: "хв",
  ...
  grades_year_summary: "Результати за весь навчальний рік",
  grades_year_credits: "ECTS за рік",
  grades_year_average: "Середній за рік",
  grades_year_completed: "Предмети за рік",
