export const sk = {
  ...
  schedule_break: "Prestávka",
  schedule_hour_short: "h",
  schedule_minute_short: "min",
  ...
  grades_year_summary: "Výsledky za celý akademický rok",
  grades_year_credits: "ECTS za rok",
  grades_year_average: "Ročný priemer",
  grades_year_completed: "Predmety za rok",
