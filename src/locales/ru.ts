...
export const ru: TranslationDictionary = {
  ...
  schedule_hour_short: "ч",
  schedule_minute_short: "мин",
  ...
  grades_year_summary: "Результаты за весь учебный год",
  grades_year_credits: "ECTS за год",
  grades_year_average: "Средний за год",
  grades_year_completed: "Предметы за год",
